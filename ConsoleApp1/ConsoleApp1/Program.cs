...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            //Texto informativo para consultar o livro pelo
            //número de registro do sistema
            Console.WriteLine("Informe o livro a ser consultado: ");
            //Parte do código que recebe as informações
            //de registro do livro e coloca na variável
            //numeroDoLivro
            var numeroDoLivro = Console.ReadLine();
            //Aqui realizo a comparação das informações
            //do livro informado com o que tenho disponível em estoque
