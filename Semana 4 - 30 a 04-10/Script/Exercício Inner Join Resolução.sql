...
select Usuarios.Usuario, count(Carros.Modelo) as 'Modelo' 
from Carros inner join Usuarios on Carros.UsuInc = Usuarios.Id 
where Usuarios.usuario like 'Fe%'
group by Usuarios.Usuario order by Usuarios.Usuario desc
